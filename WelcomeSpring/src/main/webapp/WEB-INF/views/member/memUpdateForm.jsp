...
<div class="container">
  ...
  <div class="panel panel-default">
      ...
      <form name="frm" action="${contextPath}/memUpdate.do" method="post">
         ...
         <table class="table table-bordered" style="text-align: center; border: 1px solid #dddddd;">
           ...
           <tr>
             ...
             <td colspan="2"><input id="memPassword1" name="memPassword1" onkeyup="passwordCheck()" class="form-control" type="password" maxlength="20" placeholder="변경할 비밀번호를 입력하세요."/></td>            
           </tr>
           <tr>
             <td style="width: 110px; vertical-align: middle;">비밀번호확인</td>
             <td colspan="2"><input id="memPassword2" name="memPassword2" onkeyup="passwordCheck()" class="form-control" type="password" maxlength="20" placeholder="변경할 비밀번호를 확인하세요."/></td>            
           </tr>
            <tr>
    ...
    <div class="panel-footer">Welcome Spring by GM...</div>
  </div>
</div>
</body>
</html>